...
sed "s|<OLLAMA_USER>|$USER|g" "$BASE_DIR/config/com.ollama.wrapped.service.plist" > "/tmp/com.ollama.wrapped.service.plist"
sudo cp "/tmp/com.ollama.wrapped.service.plist" /Library/LaunchDaemons/
rm "/tmp/com.ollama.wrapped.service.plist"

sudo chown root:wheel /Library/LaunchDaemons/com.ollama.wrapped.service.plist
sudo chmod 644 /Library/LaunchDaemons/com.ollama.wrapped.service.plist
...
sudo launchctl unload /Library/LaunchDaemons/com.ollama.wrapped.service.plist 2>/dev/null || true
